...
// Replace with darkColorScheme initialization when dark theme task is assigned
...
fun FinancesTheme(
    ...
    if (!view.isInEditMode) SideEffect {
        ...
        // Replace with initialization through darkTheme when dark theme task is assigned
    }
